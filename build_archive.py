...
for msg in messages[::]:
    ...
    if detail["from_email"] in emailwhitelist and emailinfo not in Emaillist and "Confirm".casefold() not in emailinfo.casefold() and "訂閱".casefold() not in emailinfo.casefold() :
